...
import com.example.azakron.databinding.ActivityNewNoteBinding
...
class NewNote : AppCompatActivity() {
    ...
    private fun setupTags() {
        ...
        availableTags.forEach { tagName ->
            ...
            chip.checkedIconTint = android.content.res.ColorStateList.valueOf(getColor(R.color.primary))
    ...
    private fun close() {
        binding.btnClose.setOnClickListener {
            ...
            if (hasContent) {
                ...
                // Botão Descartar
                dialogView.findViewById<com.google.android.material.button.MaterialButton>(R.id.btnDiscard).setOnClickListener {
                    isClosing = true
                    clearTemporaryData()
                    val intent = Intent(this, Notes::class.java)
                    startActivity(intent)
